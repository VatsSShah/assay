...
def evaluate_protocol(observation: Observation, attack: str) -> OracleResult:
    ...
    if not isinstance(facts, dict) or not facts:
        raise ValidationError(f"{observation.task_id}: protocol oracle saw no protocol facts")
...
def evaluate_behavioral(observation: Observation, attack: str) -> OracleResult:
    ...
    if not isinstance(actions, list) or not actions:
        raise ValidationError(f"{observation.task_id}: behavioral oracle saw no recorded actions")
